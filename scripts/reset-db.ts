...
const resetDb = async () => {
  ...
  try {
    ...
    await sql`DROP TABLE IF EXISTS "stream_chat" CASCADE`;
    await sql`DROP TABLE IF EXISTS "streams" CASCADE`;
    await sql`DROP TABLE IF EXISTS "products" CASCADE`;
    await sql`DROP TABLE IF EXISTS "marketplace" CASCADE`;
    await sql`DROP TABLE IF EXISTS "community_members" CASCADE`;
    await sql`DROP TABLE IF EXISTS "forum_posts" CASCADE`;
